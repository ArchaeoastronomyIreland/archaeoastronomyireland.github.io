...
(function() {
    ...
    window.clearResultsDisplay = function() { // Made global
        ...
        // --- IMPORTANT REVERTED CHANGE ---
        // Changed back to re-assigning the array to a new empty one, as this was the original behavior
        // that allowed polygons to be visible. We will diagnose the export issue from this working state.
        window.scriptCOverlayGroups = [];
        // --- END REVERTED CHANGE ---
    };
    ...
    async function createAndAddPolygonLayer(
        ...
        // --- DIAGNOSTIC LOG 1 ---
        console.log(`[Main Script] Added LayerGroup for ${layerGroupName}. Current window.scriptCOverlayGroups length: ${window.scriptCOverlayGroups.length}`);
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            // --- DIAGNOSTIC LOG 2 ---
            console.log("--- [Main Script] Final State of window.scriptCOverlayGroups after all additions ---");
            console.log("Array length:", window.scriptCOverlayGroups.length);
            window.scriptCOverlayGroups.forEach((lg, index) => {
                console.log(`  Main Script LG ${index}: Name: ${lg.layerNameForControl || 'Unnamed'}, Layers: ${lg.getLayers().length}`);
            });
            console.log("--- End Main Script Diagnostics ---");
            // --- END DIAGNOSTIC LOG 2 ---
        });
